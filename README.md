...
<div style="text-align: center;">
     <video style="max-width:130%;box-shadow:0 2.8px 2.2px rgba(0, 0, 0, 0.12);outline:none;" loop="true" autoplay="autoplay" controls="controls">
...
<div style="text-align: center;">
    <video style="max-width:130%;box-shadow:0 2.8px 2.2px rgba(0, 0, 0, 0.12);outline:none;" loop="true"  controls="controls">
